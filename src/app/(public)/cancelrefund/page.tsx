  ...
  return (
    <div className="max-w-4xl mx-auto px-6 py-8 space-y-8">
      ...
      <section className="policy-header">
        <h2
          className={`${tenorsans.variable} font-tenor text-center text-3xl sm:text-4xl font-semibold text-gray-800`}
        >
          Cancellation and Exchange Policy
        </h2>
        <p className="text-lg text-gray-600 mt-4">
          At <span className="font-bold text-xl">Recens</span>, we strive to
          deliver one-of-a-kind clothing pieces crafted with care and precision.
          While we aim for perfection in every order, we understand that
          sometimes adjustments might be needed. Below are our policies
      ...
      <section className="order-cancellation">
        <h2
          className={`${tenorsans.variable} font-tenor text-2xl font-semibold text-gray-800`}
        >
          Order Cancellation
        </h2>
