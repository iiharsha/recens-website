  ...
  return (
    <div className="max-w-4xl mx-auto px-6 py-8 space-y-8">
      ...
      <section className="policy-header">
        <h2 className={`${tenorsans.variable} font-tenor text-center text-3xl sm:text-4xl font-semibold text-gray-800`}>
          Cancellation and Exchange Policy
        </h2>
        <p className="text-lg text-gray-600 mt-4">
          At <span className="font-bold text-xl">Recens</span>, we strive to deliver one-of-a-kind clothing pieces crafted with care and precision. While we aim for perfection in every order, we understand that sometimes adjustments might be needed. Below are our policies regarding cancellations and exchanges:
        </p>
      </section>

      {/* Order Cancellation */}
      <section className="order-cancellation">
        <h2 className={`${tenorsans.variable} font-tenor text-2xl font-semibold text-gray-800`}>
          Order Cancellation
        </h2>
        <ul className="list-disc pl-6 text-lg text-gray-600 mt-4 space-y-2">
          ...
          <li>
            After 24 hours, cancellations are not permitted as production for your custom piece begins immediately.
          </li>
          <li>
      ...
      <section className="exchange-policy">
        ...
        <p className="text-lg text-gray-600 mt-4">
          <span className="font-bold">Returns are not allowed.</span> However, we do offer exchanges for eligible items.
        </p>
        <ul className="list-disc pl-6 text-lg text-gray-600 mt-4 space-y-2">
          <li>
            The item must be{" "}
      ...
      <section className="request-exchange">
        ...
        <ol className="list-decimal pl-6 text-lg text-gray-600 mt-4 space-y-2">
          <li>
            ...
            with your order number, reason for exchange, and preferred replacement item.
          </li>
          <li>Our team will verify your request and provide instructions for returning the item to us.</li>
          <li>Once we receive and inspect the item, we will process the exchange.</li>
        </ol>
      </section>
      ...
      <section className="custom-orders">
        ...
        <p className="text-lg text-gray-600 mt-4">
          Please note that{" "}
          <span className="font-bold">customized items are non-exchangeable</span>{" "}
      ...
      <section className="damaged-items">
        ...
        <p className="text-lg text-gray-600 mt-4">
          In the unlikely event that you receive a damaged or defective item, please contact us immediately at{" "}
