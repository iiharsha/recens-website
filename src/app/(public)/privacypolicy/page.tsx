  ...
  return (
    <>
      ...
      <div className="max-w-4xl mx-auto p-4 mb-12">
        ...
        <h2 className={`${tenorsans.variable} font-tenor text-center text-3xl sm:text-4xl font-semibold mb-6`}>Privacy Policy</h2>
        <p className="text-lg mb-4">Last updated on Jan 4th, 2025</p>

        <div className="border-b mb-6"></div>

        <h2 className={`${tenorsans.variable} font-tenor text-xl font-semibold mb-4`}>WHAT DO WE DO WITH YOUR INFORMATION?</h2>
        ...
        <h2 className={`${tenorsans.variable} font-tenor text-xl font-semibold mb-4`}>CONSENT</h2>
        <p className="font-semibold">How do you get my consent?</p>
        <p>Providing personal information for a transaction implies consent. For marketing purposes, we ask for explicit consent.</p>
        <p className="font-semibold">How do I withdraw my consent?</p>
        ...
        <h2 className={`${tenorsans.variable} font-tenor text-xl font-semibold mb-4`}>DISCLOSURE</h2>
        ...
        <h2 className={`${tenorsans.variable} font-tenor text-xl font-semibold mb-4`}>THIRD-PARTY SERVICES</h2>
        ...
        <h2 className={`${tenorsans.variable} font-tenor text-xl font-semibold mb-4`}>SECURITY</h2>
        <p>We follow industry best practices to protect your personal information from unauthorized access, misuse, or loss.</p>

        <div className="border-b mb-6"></div>

        <h2 className={`${tenorsans.variable} font-tenor text-xl font-semibold mb-4`}>COOKIES</h2>
        <p>We use cookies to maintain user sessions. They do not personally identify you on other websites.</p>

        <div className="border-b mb-6"></div>

        <h2 className={`${tenorsans.variable} font-tenor text-xl font-semibold mb-4`}>AGE OF CONSENT</h2>
        <p>By using this site, you confirm that you are of legal age in your jurisdiction.</p>

        <div className="border-b mb-6"></div>

        <h2 className={`${tenorsans.variable} font-tenor text-xl font-semibold mb-4`}>CHANGES TO THIS PRIVACY POLICY</h2>
        <p>We reserve the right to modify this policy at any time. Changes take effect immediately upon posting.</p>

        <div className="border-b mb-6"></div>

        <h2 className={`${tenorsans.variable} font-tenor text-xl font-semibold mb-4`}>QUESTIONS AND CONTACT INFORMATION</h2>
