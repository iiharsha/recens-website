...
const Header = async () => {
    ...
    return (
        <header className="flex w-full items-center justify-center border-b border-black bg-white/80 px-[8px] py-[4px] md:h-[80px] md:py-0 xl:px-[48px]">
            ...
            <nav className="flex h-full w-full max-w-full items-center justify-between md:w-[1440px]">
                ...
                <div className="flex h-full w-full items-center justify-between">
                    ...
                    <Link
                        href="/"
                        title="Home"
                        className="header-link flex h-full items-center justify-center border-none"
                    >
                        <Logo size="sm" />
                    </Link>
                    <Menu menu={menu} />
